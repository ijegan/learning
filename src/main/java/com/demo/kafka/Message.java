...
public class Message extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3585994020708452061L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Message\",\"namespace\":\"com.demo.kafka\",\"fields\":[{\"name\":\"code\",\"type\":\"string\"},{\"name\":\"priority\",\"type\":[\"int\",\"null\"]},{\"name\":\"extra\",\"type\":[\"string\",\"null\"]}]}");
   ...
   */
  public static com.demo.kafka.Message.Builder newBuilder() {
    return new com.demo.kafka.Message.Builder();
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static com.demo.kafka.Message.Builder newBuilder(com.demo.kafka.Message.Builder other) {
    return new com.demo.kafka.Message.Builder(other);
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static com.demo.kafka.Message.Builder newBuilder(com.demo.kafka.Message other) {
    return new com.demo.kafka.Message.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Message>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.demo.kafka.Message.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.demo.kafka.Message other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.code)) {
        this.code = data().deepCopy(fields()[0].schema(), other.code);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.demo.kafka.Message.Builder setCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.demo.kafka.Message.Builder clearCode() {
      code = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.demo.kafka.Message.Builder setPriority(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.demo.kafka.Message.Builder clearPriority() {
      priority = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.demo.kafka.Message.Builder setExtra(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.demo.kafka.Message.Builder clearExtra() {
      extra = null;
