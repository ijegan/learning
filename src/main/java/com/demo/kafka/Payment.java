...
public class Payment extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5770195225080971208L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Payment\",\"namespace\":\"com.demo.kafka\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"amount\",\"type\":\"int\"}]}");
   ...
   */
  public Payment(java.lang.CharSequence id, java.lang.Integer amount) {
    this.id = id;
    this.amount = amount;
  }
   ...
   */
  public static com.demo.kafka.Payment.Builder newBuilder() {
    return new com.demo.kafka.Payment.Builder();
  }
   ...
   * @return A new Payment RecordBuilder
   */
  public static com.demo.kafka.Payment.Builder newBuilder(com.demo.kafka.Payment.Builder other) {
    return new com.demo.kafka.Payment.Builder(other);
  }
   ...
   * @return A new Payment RecordBuilder
   */
  public static com.demo.kafka.Payment.Builder newBuilder(com.demo.kafka.Payment other) {
    return new com.demo.kafka.Payment.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Payment>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.demo.kafka.Payment.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.demo.kafka.Payment other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.demo.kafka.Payment.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.demo.kafka.Payment.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.demo.kafka.Payment.Builder setAmount(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.demo.kafka.Payment.Builder clearAmount() {
